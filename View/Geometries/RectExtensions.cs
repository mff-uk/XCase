...
namespace XCase.View.Geometries
{
	...
	public static class RectExtensions
	{
		...
		/// <returns></returns>
		public static Rect GetEncompassingRectangle(IEnumerable<IConnectable> controls)
		{
			Rect result = controls.First().GetBounds();
			foreach (IConnectable control in controls)
			{
		...
		public static void AlignLabelsToPoint(this Rect rectangle, Point point, IEnumerable<AssociationLabel> labels)
		{
            rectangle.Offset(- rectangle.X, - rectangle.Y);
			...
			if ((position & ERectEdge.Left) == ERectEdge.Left)
			{
			    ...
			    foreach (AssociationLabel control in labels)
				{
