...
{
	public class cmdEvolve: MainMenuCommandBase
	{
        public cmdEvolve(MainWindow mainWindow, Control control)
		...
		public override void Execute(object parameter)
		{
            if (CanExecute(parameter))
            {
                ...
                if (diagramOldVersion != null)
                {
                    ...
                    XsltTestWindow.ShowDialog(evolutionChanges, diagramOldVersion, diagramNewVersion);
                }
            }
		}
