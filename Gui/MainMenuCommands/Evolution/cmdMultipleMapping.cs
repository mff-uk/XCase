...
{
	/// <summary>
	/// Opens dialog for version mapping of multiple elements
	/// </summary>
	public class cmdMultipleMapping: MainMenuCommandBase
	{
        public cmdMultipleMapping(MainWindow mainWindow, Control control)
